...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_beach'])) {
    ...
    if (!is_numeric($latitude) || !is_numeric($longitude)) {
        ...
        header('Location: /BRBMS/admin/index.php');
        exit();
    }
    ...
    try {
        ...
        $query = "INSERT INTO beaches (
                      beach_name, description, location, latitude, longitude, user_id, gcash_qr_code, image, gcash_name, gcash_phone_number
                  ) VALUES (
                      :beach_name, :description, :location, :latitude, :longitude, :user_id, :gcash_qr_code, :image, :gcash_name, :gcash_phone_number
                  )";
        ...
        $stmt->bindParam(':gcash_phone_number', $gcash_phone_number, PDO::PARAM_STR);
